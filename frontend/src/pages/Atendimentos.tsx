...
export function Atendimentos() {
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] bg-white rounded-2xl shadow-[0_2px_12px_-4px_rgba(16,24,40,0.08)] border border-gray-100/80 overflow-hidden">
      ...
      {/* ── Chat direito ── */}
      {!selecionado ? (
        <div className="hidden md:flex-1 md:flex md:flex-col md:items-center md:justify-center gap-3 bg-[#f0f2f5]">
        ...
        <div className="fixed inset-0 z-50 w-full flex flex-col min-w-0 bg-white md:static md:inset-auto md:flex-1 md:z-auto">
                  ...
                  {isHandoff && (
                    <div className="flex justify-center py-2">
                      <span className="text-[11px] text-gray-500 bg-white/70 rounded-full px-3 py-1 shadow-sm">
                        {c.modo_humano ? `🙋 ${c.remetente_nome ?? 'Equipe'} assumiu o atendimento` : '🤖 IA retomou o atendimento'}
                      </span>
                    </div>
                  )}
                        ...
                        <div className="max-w-[72%]">
                          <div className="rounded-lg rounded-tr-none px-3.5 py-2 shadow-sm relative" style={{ backgroundColor: bgColor }}>
                            ...
                            <p className="text-[11px] font-semibold mb-0.5" style={{ color: isHumano ? '#065f46' : '#075e54' }}>
                              {isHumano ? (c.remetente_nome ?? 'Equipe') : 'IA ✨'}
                            </p>
